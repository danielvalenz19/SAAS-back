// src/modules/unidadesMedida/unidadesMedida.controller.js
const service = require('./unidadesMedida.service');
...
async function update(req, res, next) {
  try {
    ...
    res.json({ ok: true, message: 'Unidad de medida actualizada' });
  } catch (err) {
    next(err);
  }
}
